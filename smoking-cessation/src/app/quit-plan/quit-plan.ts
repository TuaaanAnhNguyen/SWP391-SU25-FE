...
export class QuitPlan {
  ...
  reasonsList = [
    ...
    { id: 'reason-family', value: 'For Family/Loved Ones', label: 'For Family/Loved Ones' },
    { id: 'reason-money', value: 'Save Money', label: 'Save Money' },
    { id: 'reason-appearance', value: 'Better Appearance', label: 'Better Appearance' },
    { id: 'reason-energy', value: 'Increased Energy', label: 'Increased Energy' },
    { id: 'reason-freedom', value: 'Freedom/Control', label: 'Freedom & Control' }
  ];

  triggersList = [
    { id: 'trigger-stress', value: 'Stress', label: 'Stress' },
    { id: 'trigger-meals', value: 'After Meals', label: 'After Meals' },
    { id: 'trigger-coffee-alcohol', value: 'With Coffee/Alcohol', label: 'With Coffee/Alcohol' },
    { id: 'trigger-boredom', value: 'Boredom', label: 'Boredom' },
    { id: 'trigger-social', value: 'Social Situations (seeing others smoke)', label: 'Social Situations (seeing others smoke)' },
    { id: 'trigger-driving', value: 'Driving', label: 'Driving' },
    { id: 'trigger-morning', value: 'First Thing in the Morning', label: 'First Thing in the Morning' }
  ];

  strategiesList = [
    { id: 'strategy-avoid', value: 'Avoid Triggers', label: 'Avoid Triggers' },
    { id: 'strategy-support', value: 'Join a Support Group/Community', label: 'Join a Support Group/Community' },
    { id: 'strategy-distraction', value: 'Distract Myself', label: 'Distract myself (hobby, walk)' },
    { id: 'strategy-hydration', value: 'Hydration', label: 'Drink water/healthy drinks' },
    { id: 'strategy-meditation', value: 'Mindfulness/Meditation', label: 'Practice mindfulness/meditation' },
    { id: 'strategy-exercise', value: 'Exercise Regularly', label: 'Exercise regularly' },
    { id: 'strategy-reward', value: 'Plan Rewards', label: 'Plan Rewards' },
    { id: 'strategy-coach', value: 'Connect with a Coach', label: 'Connect with a Coach (VIP Only)' }
  ];
  ...
  const diffDays = Math.ceil((quitDate.getTime() - today.getTime()) / (1000 * 60 * 60 * 24));
  if(diffDays > 7) {
    this.quitDateWarning = 'We recommend choosing a start date as close as possible (within 7 days).'
    return true;
  }
